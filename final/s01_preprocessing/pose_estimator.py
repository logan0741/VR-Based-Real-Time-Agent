...
LOCAL_MODEL_DIR = Path(__file__).resolve().parents[2] / "movenet-tensorflow2-singlepose-lightning-v4"
INPUT_SIZE = 192
...
class PoseEstimator:
    ...
    def predict(self, frame: np.ndarray) -> np.ndarray:
        """Predict 17 keypoints as shape=(17,3) float32 in [y, x, confidence]."""
