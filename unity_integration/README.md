...
2. **아바타 올리기:**
   ...
   - 방금 올린 아바타(또는 Capsule)를 선택하고, `Scripts` 폴더에 있는 `FitnessAvatarController`를 드래그해서 부착합니다.

## 4단계: 선 연결해주기 (Inspector 세팅)

스크립트들이 서로, 그리고 아바타의 뼈와 연결될 수 있도록 지정해 주는 단계입니다.

1. **WebSocketClient 세팅:**
...
2. **FitnessAvatarController 세팅 (제일 중요 ⭐️):**
   - Hierarchy에서 **내 3D 아바타**를 클릭합니다.
   - 인스펙터의 Fitness Avatar Controller 부분을 봅니다.
